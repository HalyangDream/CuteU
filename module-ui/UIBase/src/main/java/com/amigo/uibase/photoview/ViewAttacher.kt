package com.amigo.uibase.photoview
...
class ViewAttacher// Wait for the confirmed onDoubleTap() instead// Can sometimes happen when getX() and getY() is called// Check to see if the user tapped on the photo// forward long click listener// Create Gesture Detectors...
    (val mImageView: ImageView) : View.OnTouchListener,
    ...
    val onGestureListener: OnGestureListener = object : OnGestureListener {
