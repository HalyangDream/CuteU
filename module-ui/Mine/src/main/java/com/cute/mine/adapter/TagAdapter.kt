...
import com.cute.mine.databinding.ItemTagBinding
import com.cute.mine.databinding.ItemTagTitleBinding
                    ...
                    if (item.selected) {
                        tagBinding.ivRoot.shapeDrawableBuilder.setSolidColor(
                            ContextCompat.getColor(
                                context,
                                com.cute.uibase.R.color.app_main_color
                            )
                        )
                            .intoBackground()
                    } else {
                        tagBinding.ivRoot.shapeDrawableBuilder
                            ...
                            .setStrokeColor(
                                ContextCompat.getColor(
                                    context,
                                    com.cute.uibase.R.color.color_tag_border
                                )
                            )
                            .setSolidColor(
                                ContextCompat.getColor(
                                    context,
                                    com.cute.uibase.R.color.white
                                )
                            )
                            .intoBackground()
                    }
