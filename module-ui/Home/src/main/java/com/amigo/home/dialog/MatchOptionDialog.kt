...
import com.amigo.home.databinding.DialogMatchOptionBinding
import com.amigo.home.databinding.ItemMatchOptionBinding
...
//            binding.ivMatchType.loadImage(item.icon)
            ...
            if (!item.price.isDigitsOnly() || item.price == "0") {
                ...
                binding.tvPrice.text =
                    if (item.price.isDigitsOnly()) context.getString(com.amigo.uibase.R.string.str_free) else "${item.price}"
            } else {
