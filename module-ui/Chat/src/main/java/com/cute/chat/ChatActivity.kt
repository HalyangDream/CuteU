...
import com.cute.chat.adapter.ChatAdapter
import com.cute.chat.adapter.ChatHeaderAdapter
import com.cute.chat.databinding.ActivityChatBinding
import com.cute.chat.databinding.LayoutChatTopBinding
import com.cute.uibase.dialog.MoreDialog
import com.cute.uibase.dialog.ReportDialog
import com.cute.chat.intent.ChatIntent
import com.cute.chat.listener.IChattingAction
import com.cute.chat.state.ChatState
import com.cute.chat.viewmodel.ChatViewModel
...
import com.cute.picture.loadDrawable
    ...
    private fun bindChatState(state: ChatState) {
        when (state) {
            ...
            is ChatState.ReportUserResult -> {
                if (state.result) {
                    Toaster.showShort(
                        this, getString(com.cute.uibase.R.string.str_report_success)
                    )
                } else {
                    Toaster.showShort(
