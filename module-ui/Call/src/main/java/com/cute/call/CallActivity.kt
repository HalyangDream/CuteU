...
import com.cute.call.adapter.VideoChatAdapter
import com.cute.call.adapter.VideoMsg
import com.cute.call.databinding.ActivityCallBinding
import com.cute.call.databinding.LayoutCallingBinding
import com.cute.call.databinding.LayoutMakeCallBinding
import com.cute.call.databinding.LayoutMakeCallMatchBinding
import com.cute.call.dialog.UnLockDeviceFunctionDialog
import com.cute.call.intent.CallIntent
import com.cute.call.intent.TelephoneIntent
import com.cute.call.state.CallState
import com.cute.call.state.TelephoneCallerState
import com.cute.call.viewmodel.CallViewModel
...
import com.cute.logic.http.response.call.DeviceFunctionEnum
...
import com.cute.picture.transformation.RoundRadius
import com.cute.tool.EventBus
import com.cute.tool.EventBus.subscribe
import com.cute.tool.KeyboardUtil
...
import com.cute.uibase.media.VideoPlayerAdapterListener
...
class CallActivity : BaseModelActivity<ActivityCallBinding, CallViewModel>() {
        ...
        when (state) {
            ...
            is CallState.StartCall -> {
                ...
                requestMultiplePermission(*permissions.toTypedArray(), onGranted = {
                    ...
                    //提示用户需要给权限
                    Toaster.showShort(
                        this@CallActivity, com.cute.uibase.R.string.str_please_grant_permission
                    )
                })
            }
        ...
        when (state) {
            ...
            is TelephoneCallerState.Connecting -> {
                if (isMatchCall) {
                    ...
                    makeMatchCallHolder?.changeCallStateContent(com.cute.uibase.R.string.str_connecting)
                } else {
                    makeCallHolder?.buttonEnable(false)
                    makeCallHolder?.changeCallStateContent(com.cute.uibase.R.string.str_connecting)
                }
            }
            ...
            is TelephoneCallerState.FinishCall -> {
                insertFinishCallRecord(
                    getString(com.cute.uibase.R.string.str_call_end),
    ...
    inner class MakeCallHolder(view: View) {
        ...
        private fun initView() {
            if (isStrategyCall) {
                changeCallStateContent(com.cute.uibase.R.string.str_waiting_for_response)
                buttonEnable(true)
            } else {
                changeCallStateContent(com.cute.uibase.R.string.str_calling)
                buttonEnable(false)
                val caller = userDataStore.getUid()
                val callee = callerInfo!!.callee
                ...
                when (scenes) {
                    ...
                    ErrorScenes.BUSY -> {
                        ...
                        binding.tvCallErrorTitle.text =
                            getString(com.cute.uibase.R.string.str_call_buys)
                        binding.tvCallErrorContent.text =
                            Html.fromHtml(getString(com.cute.uibase.R.string.str_user_busy_tip))
                    ...
                    ErrorScenes.OFFLINE -> {
                        ...
                        binding.tvCallErrorTitle.text =
                            getString(com.cute.uibase.R.string.str_call_offline)
                        binding.tvCallErrorContent.text =
                            Html.fromHtml(getString(com.cute.uibase.R.string.str_user_offline_tip))
                    ...
                    ErrorScenes.FAILURE -> {
                        ...
                        binding.tvCallErrorTitle.text =
                            getString(com.cute.uibase.R.string.str_call_failure)
                        binding.tvCallErrorContent.text =
                            Html.fromHtml(getString(com.cute.uibase.R.string.str_user_fail_tip))
    ...
    inner class CallingHolder(view: View, private val callId: String) {
        ...
        private fun changeCameraDirection() {
            ...
            if (cameraSwitchInfo!!.enable) {
                ...
                val resId =
                    if (nextUseFrontCamera) com.cute.uibase.R.string.str_front_camera_switched else com.cute.uibase.R.string.str_rear_camera_switched
        ...
        private fun changeCameraStatus() {
            ...
            if (cameraCloseInfo!!.enable) {
                ...
                if (nextCloseCamera) {
                    ...
                    Toaster.showShort(
                        this@CallActivity, com.cute.uibase.R.string.str_camera_is_turned_off
                    )
                } else {
                    //重新设置本地视图
                    requestMultiplePermission(android.Manifest.permission.CAMERA, onGranted = {
                        ...
                        Toaster.showShort(
                            this@CallActivity, com.cute.uibase.R.string.str_camera_is_turned_on
                        )
                    }, onDenied = {
                        Toaster.showShort(
                            this@CallActivity,
                            com.cute.uibase.R.string.str_please_grant_permission
                        )
                    })
        ...
        private fun changeVoiceStatus() {
            ...
            if (voiceMuteInfo!!.enable) {
                ...
                val resId =
                    if (nextMuteVoice) com.cute.uibase.R.string.str_micrphone_is_off else com.cute.uibase.R.string.str_micrphone_is_on
                Toaster.showShort(this@CallActivity, resId)
            } else {
                //显示付费
        ...
        fun handleUnlockDeviceFunctionResult(result: Boolean, unlockItem: DeviceFunctionInfo) {
            val resId =
                if (result) com.cute.uibase.R.string.str_unlock_success else com.cute.uibase.R.string.str_unlock_failure
            Toaster.showShort(this@CallActivity, resId)
            if (result) {
