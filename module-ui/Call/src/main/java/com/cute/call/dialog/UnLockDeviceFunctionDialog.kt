...
import com.cute.call.databinding.DialogUnlockDeviceFunctionBinding
        ...
        when (enum) {
            DeviceFunctionEnum.CAMERA_CLOSE -> {
                ...
                binding.tvDeviceFunction.text =
                    context?.getString(com.cute.uibase.R.string.str_camera_turned_off)
                binding.tvDeviceFunctionTip.text =
                    context?.getString(com.cute.uibase.R.string.str_camera_turned_off_tip)
            }

            DeviceFunctionEnum.CAMERA_SWITCH -> {
                binding.ivDeviceFunction.setImageResource(R.drawable.ic_dialog_unlock_camera_switch)
                binding.tvDeviceFunction.text =
                    context?.getString(com.cute.uibase.R.string.str_using_rear_camera)
                binding.tvDeviceFunctionTip.text =
                    context?.getString(com.cute.uibase.R.string.str_using_rear_camer_tip)
            }

            DeviceFunctionEnum.VOICE_MUTE -> {
                binding.ivDeviceFunction.setImageResource(R.drawable.ic_dialog_unlock_voice_mute)
                binding.tvDeviceFunction.text =
                    context?.getString(com.cute.uibase.R.string.str_microphone_turned_off)
                binding.tvDeviceFunctionTip.text =
                    context?.getString(com.cute.uibase.R.string.str_microphone_turned_off_tip)
            }
        }
